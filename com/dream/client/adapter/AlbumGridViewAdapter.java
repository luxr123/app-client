package com.dream.client.adapter;
...
public class AlbumGridViewAdapter extends BaseAdapter implements OnClickListener {
	...
	public AlbumGridViewAdapter(Context c, ArrayList<String> dataList, ArrayList<String> selectedDataList) {
		...
		for(String s: selectedDataList)
			System.out.println("selectedDataList:" + s);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (path.contains("default")) {
			...
			ImageManager2.from(mContext).displayImage(viewHolder.imageView, path, R.drawable.camera_default, 100, 100);
		}
